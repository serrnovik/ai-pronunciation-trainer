...
To run the program locally, you can simply use the provided helper script:

```powershell
./RunApp.ps1
```

This script will automatically set up the virtual environment, install dependencies, and start the application.

## Features

- **Custom Text Practice**: You can now enter your own text for practice! - Click "Custom" in the difficulty selector. - Enter your text. - Choose to split by "Sentence", "Phrase" (comma/pause), or "Word".
